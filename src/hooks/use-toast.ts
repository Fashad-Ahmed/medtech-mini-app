...
/**
 * Extended toast properties including id and optional React nodes for title,
 * description, and action elements
 */
 ...
 * @param state Current state containing array of toasts
 * @param action Action to perform on the toast state
 ...
 * Uses a singleton pattern to maintain toast state across components
